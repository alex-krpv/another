...
//Вам дано эффективное решение первой части задачи о личном бюджете.
//Для хранения операций оно использует древовидную структуру данных, 
//позволяющую избежать модификации каждого дня для длинных интервалов.

//Ваша задача — сделать с этим решением то, что вы сделали со своим решением 
//в предыдущей части этого задания.Добавьте поддержку нового запроса :
...
//Spend <дата начала> <дата конца> <прибыль> — учесть, 
...
//Измените данную в заготовке кода реализацию базового функционала, добавив требующиеся возможности.
//А потом отправьте на проверку.
//Как будет тестироваться ваш код
//Выполнятся те же тесты, что и в предыдущем случае, но дополнительно будет проверена эффективность для 
//большого количества запросов.

//Отладка налогообложения из разбора задачи
//https://blushing-medicine-fbd.notion.site/3-7f824e2a61ab453c99e97867e2a54716
//Ввод:
//6
